...
import DevV2FlagsPanel from '@/components/chronicle/DevV2FlagsPanel';
import { clearUserScopedState } from '@/v2/shared/sessionCleanup';
  ...
  return (
    <V2Surface hideSettingsControl>
      <div className="proto-page" data-testid="v2-settings">
        ...
        {/* DEVELOPER — only when Developer Mode access is explicitly granted. */}
        {canAccessDevPanel && (
          <SettingsSection title="Developer" description="Visible to developer accounts only.">
            <div className="proto-set-row" data-testid="v2-developer-section">
