...
const PERSON_PATTERNS = /\b(manager|supervisor|colleague|coworker|co-worker|boss|team\s*lead|director|hr|human\s*resources|employee|staff|worker|mr\.?|mrs\.?|ms\.?|dr\.?)\b/i;
