...
export const SceneClosing: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLOR.bg, alignItems: 'center', justifyContent: 'center', flexDirection: 'column', gap: 22, opacity: opacity * fadeOut }}>
      <div style={{ fontFamily: FONT.ui, fontSize: 24, fontWeight: 500, color: COLOR.text, textAlign: 'center', letterSpacing: '-0.005em' }}>
        Record it in your own words.
      </div>
      <div style={{ width: 60, height: 1, background: COLOR.primary, opacity: 0.6 }} />
